//FSAzPredict.cpp - Varun Chandola
...
{\
  ...
  fprintf(stderr, \
"Usage:\n\n" \
"FSAzPredict -i sequence_filename -m model_filename -o outputfile -a max_alphabet\n\n"); \
  exit(1); \
}
...
int main(int argc, char *argv[]){
    ...
    predictSequences(nodesMap,str2intnodemap,int2strnodemap,str2intedgemap,int2stredgemap,windows,out,n,l,totaledges,0);
    //sequences predicted
